  ...
  return {
    ...
    link: function($scope, $element, $attrs) {
      ...
      function checkTypes(dataTransfer) {
        var typesMatch = _.contains(dataTransfer.types, 'image/jpeg');
      ...
      $element.on('dragstart dragover dragenter', function(event) {
      ...
      $overlay.on('dragstart dragover dragenter', function(event) {
        event.stopPropagation();
        event.preventDefault();
      });
