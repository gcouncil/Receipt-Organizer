...
angular.module('epsonreceipts.itemsToolbar').directive('itemsToolbarUpdateReportButton', function(
  reportStorage,
  $templateCache,
  $dropdown,
  $q,
  ...
  var reportsTemplateId = _.uniqueId('items-toolbar-update-report-button-dropdown-template');
  $templateCache.put(reportsTemplateId, require('./items-toolbar-update-report-button-dropdown-template.html'));
  ...
  return {
    ...
    link: function($scope, $element) {
      ...
      dropdown.$scope.reportItems = function(report) {
        var counter = 0;
