...
angular.module('epsonreceipts.scanning').factory('scanner', function($timeout, $q, imageStorage) {
  ...
  function onNewImage() {
    ...
    var base64 = 'data:image/jpeg;base64,' + DWObject.SaveSelectedImagesToBase64Binary();
    imageStorage.addImage({ data: base64 });
