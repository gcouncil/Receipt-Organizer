...
angular.module('epsonreceipts.scanning').factory('scanner', function($interval, $q, imageStorage, receiptStorage) {
  ...
  function onNewImage() {
    ...
    var size = DWObject.GetSelectedImagesSize(1); // Prepare image as JPEG
    var array = new Uint8Array(size);
    DWObject.SaveSelectedImagesToBytes(size, array);
    var blob = new Blob([array.buffer], { type: 'image/jpeg' });
