...
angular.module('epsonreceipts').config(function($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider.state('receipts.thumbnails', {
    url: '/thumbnails',
    template: '<receipt-thumbnail-grid receipts="receipts.pagination.items" selection="receipts.selection" paginationhack="receipts.pagination"></receipt-thumbnail-grid>'
  });
