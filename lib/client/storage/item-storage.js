...
angular.module('epsonreceipts.storage').factory('itemStorage', function(
  ...
  // TODO: When offline, load from cache
  // TODO: When online/offline state change, force reload
  // TODO: When switching to online, upload and remove item from cache (NOTE: Images need to be uploaded)
  // TODO: When offline changes should be persisted to cache
  // TODO: When uploading offline cache, show message
  ...
  var itemStorage = {
    ...
    // TODO: This API is a hack...
    load: function(clear, skip) {
      console.log('state', storageEvents.state);
      console.trace('load items');
      ...
      if (this.promise || skip) { return this.promise; }
