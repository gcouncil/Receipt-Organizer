...
angular.module('epsonreceipts.twain').factory('twain', function(
  ...
  angular.element(document).ready(function initialize() {
    ...
    var dwt = new Dynamsoft.WebTwain({
      productKey: 'F8C14BE84941A6A931A1235D17A7FC3B1E218FD9C6557C271EFD2C3D3825C9A81E218FD9C6557C27A5247F9F83FA5A281E218FD9C6557C27CBE7C7C025C7635F30000000',
      isTrial: 'true',
      containerID: id,
    ...
    scan: function(handler) {
      return $q.all(
        ...
        if (twain.imageHandler !== _.noop) {
          alert('Error, scan already in progress');
          return;
        }
