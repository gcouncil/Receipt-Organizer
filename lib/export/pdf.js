...
module.exports = function(report, items, options, services, callback) {
  ...
  function renderTable() {
    ...
    // Table Header
    tableRow({ number: '#', vendor: 'Vendor', totalRequested: 'Total Requested', total: 'Total', date: 'Date', type: 'Type', location: 'Location', payment: 'Payment' }, 'Helvetica-Bold', 'white', 'black', 'black');
