...
function Api(config) {
  ...
  this.managers = {
    ...
    expenses: require('./managers/expenses-manager')(this.services.database),
  ...
  this.handlers = {
    ...
    expenses: require('./handlers/expenses-handler')(this.managers.expenses),
    images: require('./handlers/images-handler')(this.managers.images),
    tags: require('./handlers/tags-handler')(this.managers.tags)
  };
