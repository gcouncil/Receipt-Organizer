...
Drawing.prototype.insertImage = function(image, options) {
  ...
  this.container.addFile(file, image, { store: true });
  ...
  var stretch = this.doc.createElementNS(DRAWING_NAMESPACE, 'a:stretch');
  blipFill.appendChild(stretch);

  stretch.appendChild(this.doc.createElementNS(DRAWING_NAMESPACE, 'a:fillRect'));
